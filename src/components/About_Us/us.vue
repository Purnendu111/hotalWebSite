      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
              <a class="text-dark font-weight-bold">MALHAAR_GREENS</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">Our Work</h6>
            <p>
        ...
        <button class="btn"><i class="fa fa-home mr-2"></i>North Ramchandrapur</button><br>
        <button class="btn"><i class="fa fa-envelope mr-2"></i>abc@gmail.com</button><br>
        <button class="btn"><i class="fa fa-phone mr-2"></i> +91-0000000000</button><br>
