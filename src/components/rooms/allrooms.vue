  ...
  <div style="height: 100%">
            ...
            <b-row style="padding-bottom: 20px !important">
              <b-col>
                <img
                  ...
                  alt=""
                />
                Up to 2 guests. Max Adults: 2, Max Children: 1 (sharing bed)
              </b-col>
              <b-col>
                <img
            ...
            <b-row>
              <b-col>
                <b-button
                  ...
                  id="room_1"
                  @click="addRooms('room_1', 'attachBath', 'Hallway', '5100')"
                >
            ...
            <b-row>
              <b-col>
                <b-button
                  ...
                  variant="outline-primary"
                  @click="
                    addRooms('room_2', 'withOutBath', 'Green Room', '4700')
                  "
                >
                  SELECT ROOM<b-icon icon="check"></b-icon>
                </b-button>
    ...
    <b-row id="chkOutRow" v-if="roomList.length > 0" style="height: 70px">
      <b-col class="pb-2" style="text-align: right; margin-right: 50px"
        ><b-button size="lg" style="background: #003724" href="/checkout">
          <img
  ...
  methods: {
    appHt: function () {
      var h = window.innerHeight,
        ...
        chkOutRow = document.getElementById("chkOutRow") == null ? 0 : document.getElementById("chkOutRow").offsetHeight;
    ...
    addRooms(id, roomType, roomName, price) {
      ...
      document.getElementById(id + "_cncl").style.display = "inline-table";
      setTimeout(() => {
        this.appHt();
      }, 500);
    },
